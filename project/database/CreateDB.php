...
{//for when our tables were removed, we use this method
  
        private $createTableQueries = 
        [
          //But this queryes is incomplete and not complate.You are more complate
...
//it is a Sample for inserting. Entering a handly
        ...
        public function run()//for create and insert whit code to database
        {
